...
def create_model(num_classes):
    ...
    # weights_dict1 = torch.load("weights/pre_efficientnetv2-s.pth")
    # net_weights = net.state_dict()
    # net.load_state_dict(weights_dict, strict=False)
    # missing_keys, unexpected_keys = net.load_state_dict(weights_dict1, strict=False)
    # if len(missing_keys) != 0 or len(unexpected_keys) != 0:
    #     print("missing_keys: ", missing_keys)
    #     print("unexpected_keys: ", unexpected_keys)
    # first_layer = net.stem
    # backbone = []
    # backbone.append(net.stem)
    # backbone.append(net.blocks)
    # backbone = nn.Sequential(*backbone)
    #================================================================
    # d2 = backbone.state_dict()
